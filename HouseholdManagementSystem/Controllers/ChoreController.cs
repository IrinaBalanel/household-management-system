...
namespace HouseholdManagementSystem.Controllers
{
    public class ChoreController : Controller
    {
        ...
        public ActionResult List()
        {
            ...
            string url = "choredata/listchores";
        ...
        public ActionResult Show(int id)
        {
            ...
            //HttpClient client = new HttpClient();
            string url = "choredata/findchore/" + id;
            ...
            url = "roomdata/listroomsforchore/" + id;
            ...
            url = "roomdata/listroomsnotforchore/" + id;
            response = client.GetAsync(url).Result;
        ...
        public ActionResult Assign(int ChoreId, int RoomId)
        {
            ...
            //HttpClient client = new HttpClient();
            string url = "choredata/assignchoretoroom/" + ChoreId + "/" + RoomId;
        ...
        public ActionResult Unassign(int ChoreId, int RoomId)
        {
            GetApplicationCookie();
            //HttpClient client = new HttpClient();
            string url = "choredata/unassignchorefromroom/" + ChoreId + "/" + RoomId;
            HttpContent content = new StringContent("");
            content.Headers.ContentType.MediaType = "application/json";
        ...
        public ActionResult Update(int id, Chore chore)
        {
            ...
            try
            {
                ...
                //HttpClient client = new HttpClient();
                string url = "choredata/updatechore/" + id;
        ...
        public ActionResult Delete(int id)
        {
            ...
            //HttpClient client = new HttpClient();
            string url = "choredata/deletechore/" + id;
            HttpContent content = new StringContent("");
            HttpResponseMessage response=client.PostAsync(url, content).Result;
